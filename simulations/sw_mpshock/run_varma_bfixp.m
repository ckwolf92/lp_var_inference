...
settings.est.type = 'bfixp'; % estimation methods type
...
for i_dgp = 1:numdgp
    ...
    dgp.A           = dgp_inputs{1}.A;
    dgp.A_c         = dgp_inputs{1}.A_c;
    dgp.H           = dgp_inputs{1}.H;
    dgp.H_c         = dgp_inputs{1}.H_c;
    dgp.D           = dgp_inputs{1}.D;
    dgp.Sigma       = dgp_inputs{1}.Sigma;
    dgp.alpha_tilde = dgp_inputs{1}.alpha_tilde;
